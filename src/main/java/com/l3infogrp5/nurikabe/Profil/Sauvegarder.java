...
// public class Sauvegarder implements Path {
    ...
    // public Sauvegarder() {
    //     System.out.println("repertoire = " + repertoire_Courant.toString());
    ...
    //     if (!dossierExistants(repertoire_Lvl) || repertoire_Lvl.listFiles().length == 0) {
    ...
    //     for (File fichier : repertoire_Lvl.listFiles()) {
    ...
    //     ArrayList<String> fichiers = ajoutFichiers(repertoire_Courant);
    ...
    //             Files.createDirectories(Paths.get(repertoire_Save.toString()));
    //             System.out.println("Dossier save créé");
    //         } else {
    //             // Se déplacer dans le nouveau dossier "save"
    //         }
    //         repertoire = new File(repertoire_Save.toString());
    ...
    //             Files.createDirectories(Paths.get(repertoire_Lvl.toString()));
    //         }
    //         Files.createDirectories(Paths.get(repertoire_Lvl.toString() + nom_Joueur));
    ...
    //             Files.createDirectories(Paths.get(repertoire_Score.toString()));
